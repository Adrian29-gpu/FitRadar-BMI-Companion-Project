...
public class HistoryDetailScene {
    private Stage stage;
    ...
    public Scene show(int id, int historyId) {
        history = HistoryControllers.getHistoryById(historyId);
    ...
    private String getHydrationResult() {
        String hydrationResponse = history.getWater();
    ...
    private String getExerciseResult() {
        String exerciseResponse = history.getExercise();
    ...
    private String getSleepResult() {
        String sleepResponse = history.getSleep();
    ...
    private String getJunkfoodResult() {
        String junkFoodResponse = history.getJunkfood();
    ...
    private String getVegetableResult() {
        String vegetableResponse = history.getVegetable();
    ...
    private String getSmokeResult() {
        String smokeResponse = history.getSmooking();
