...
public class ResultScene {
    ...
    public Scene show(int id) {
        ...
        Pane root = new Pane();
        root.getChildren().addAll(rectangle, judulHistory, summary, buttonHome, hydration, option1, exercise, option2,
                sleep, option3, junkFood, option4, fruits, option5, smoke, option6);
