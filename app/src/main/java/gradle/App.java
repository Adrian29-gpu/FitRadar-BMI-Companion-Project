...
public class App extends Application {
    ...
    private Scene inputScene(Stage stage) {
        ...
        Pane root = new Pane();
        root.getChildren().addAll(input, input2, buttonBox, input3, input4, buttonBox2, option7, input5, input6, buttonBox3, option11, input7, input8, buttonBox4, input9, input10, input11, input12, buttonBox6, input13, buttonBox7, buttonResult);
        root.getStyleClass().add("background");
